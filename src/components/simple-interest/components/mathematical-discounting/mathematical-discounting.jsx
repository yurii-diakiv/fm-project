    ...
    return (
        ...
        >
            ...
            <span className={styles.textBlock}>
                Банк у першому кварталі випустив депозитний сертифікат з терміном погашення в кінці цього ж кварталу. 
                Сертифікат викуповується за 100 грн. Оголошена прибутковість - 20% простих річних. Знайти ціну 
                продажу сертифікату і величину дисконту, якщо вважати, що часова база становить 366.
            </span>
